...
{
/// <summary>
/// Wrapper class for a matrix of R characters objects
/// </summary>
/// <remarks>Instances of this class can be created from RDataFactory
/// </remarks>
    public class RStringMatrix : RData
    {

        private List<List<String>> m_value;
        ...
        /// </summary>
        /// <remarks></remarks>
        protected RStringMatrix()
        {
            m_type = Constants.TYPE_MATRIX;
            m_rclass = Constants.RCLASS_MATRIX;
        }

        internal RStringMatrix(String name, List<List<String>> value)
        {
            m_type = Constants.TYPE_MATRIX;
            m_rclass = Constants.RCLASS_MATRIX;
        ...
        /// <summary>
        /// Gets the matrix of String values for this RData.
        /// </summary>
        /// <value></value>
        /// <returns>2-dimensional array of strings cast as type Object</returns>
        /// <remarks></remarks>
        public object Value
        {
            get
