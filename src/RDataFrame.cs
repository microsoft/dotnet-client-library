...
{
/// <summary>
/// Wrapper class for a R data.frame object
/// </summary>
/// <remarks>Instances of this class can be created from RDataFactory
/// </remarks>
    public class RDataFrame : RData
    {
        ...
        {
            m_type = Constants.TYPE_DATAFRAME;
            m_rclass = Constants.RCLASS_DATAFRAME;
        }

        internal RDataFrame(String name, List<RData> value)
        {
            m_type = Constants.TYPE_DATAFRAME;
            m_rclass = Constants.RCLASS_DATAFRAME;
