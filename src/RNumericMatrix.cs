...
{
/// <summary>
/// Wrapper class for a matrix of R numeric objects
/// </summary>
/// <remarks>Instances of this class can be created from RDataFactory
/// </remarks>
    public class RNumericMatrix : RData
    {

        private List<List<Double?>> m_value;
        ...
        /// </summary>
        /// <remarks></remarks>
        protected RNumericMatrix()
        {
            m_type = Constants.TYPE_MATRIX;
            m_rclass = Constants.RCLASS_MATRIX;
        }

        internal RNumericMatrix(String name, List<List<Double?>> value)
        {
            m_type = Constants.TYPE_MATRIX;
            m_rclass = Constants.RCLASS_MATRIX;
        ...
        /// <summary>
        /// Gets the numeric matrix values for this RData.
        /// </summary>
        /// <value></value>
        /// <returns>2-dimensional array of doubles cast as type Object</returns>
        /// <remarks></remarks>
        public object Value
        {
            get
