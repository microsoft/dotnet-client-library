...
{
/// <summary>
/// Wrapper class for a vector of R logical objects
/// </summary>
/// <remarks>Instances of this class can be created from RDataFactory
/// </remarks>
    public class RBooleanVector : RData
    {

        private String m_name = "";
        private List<Boolean?> m_value;
        ...
        internal RBooleanVector(String name, List<Boolean?> value)
        {
            m_type = Constants.TYPE_VECTOR;
            m_rclass = Constants.RCLASS_BOOLEAN;
        ...
        /// <summary>
        /// Gets the vector of boolean values for this RData.
        /// </summary>
        /// <value></value>
        /// <returns>Array of boolean cast as type Object</returns>
        /// <remarks></remarks>
        public object Value
        {
            get
